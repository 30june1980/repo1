 ...
 * @author dgupta
 */
public class PostTransactionalExternalDataOnlyForCancel extends ConfigLoader {
  ...
  private String buildPayload() throws IOException {
    URL file = Resources
        .getResource("XMLPayload/PostForCancel/PostTransactionalExternalDataOnlyForCancel.xml");
