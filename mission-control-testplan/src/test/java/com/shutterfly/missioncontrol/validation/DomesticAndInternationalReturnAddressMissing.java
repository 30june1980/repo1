 ...
 *
 */
public class DomesticAndInternationalReturnAddressMissing extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/DomesticAndInternationalReturnAddressMissing.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("One return address is mandatory."));
