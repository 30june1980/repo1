 ...
 *
 */
public class InvalidRequestTypeValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("Process", "Proces");
	}
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Request type is invalid."));
