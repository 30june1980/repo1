 ...
 *
 */
public class OrganizationAndPersonPresent extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/OrganizationAndPersonPresent.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Only Person details or Organization details is valid; both cannot be valued for the same recipient."));
