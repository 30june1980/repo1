 ...
 *
 */
public class RecipientIDValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("111223333", "");
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Recipient ID is missing."));
