 ...
 *
 */
public class DeliveryMethod1Validation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("Emailed", "");
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("DeliveryMedium is missing"));
