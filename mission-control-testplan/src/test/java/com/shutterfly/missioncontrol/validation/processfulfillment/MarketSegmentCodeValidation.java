 ...
 *
 */
public class MarketSegmentCodeValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("LRG", "");
	}
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Market segment is missing."));
