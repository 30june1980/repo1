 ...
 *
 */
public class BusinessSegmentIdValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("EI", "");
	}
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Business segment is missing."));
