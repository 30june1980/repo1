 ...
 *
 */
public class DeliveryMethod2Invalid extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/DeliveryMethod2.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("DeliveryMedium Should be 'Mailed','Fax', 'Emailed' or null."));
