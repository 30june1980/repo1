 ...
 *
 */
public class RequestDateValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("2016-12-17T09:30:47Z", "");
	}
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Request date is missing."));
