 ...
 *
 */
public class DomesticAndInternationalAddressPresent extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/DomesticAndInternationalAddressPresent.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Only domestic or international mailing address is valid; both cannot be valued for the same recipient."));
