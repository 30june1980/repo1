 ...
 *
 */
public class DomesticAndInternationalReturnAddressPresent extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/DomesticAndInternationalReturnAddressPresent.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Only domestic or international return address is valid; both cannot be valued for the same recipient."));
