 ...
 *
 */
public class OrganizationAndPersonMissing extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/Validation/OrganizationAndPersonMissing.xml");		
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo("Both Person and Organization are missing"));
