...
public class PostTransactionalExternalDataOnly extends ConfigLoader {
  ...
  private String buildPayload() throws IOException {
    URL file = Resources
        .getResource("XMLPayload/PostFulfillment/PostTransactionalExternalDataOnly.xml");
  ...
  @Test(groups = "Post_TXDO_Response", dependsOnGroups = {"Process_TXDO_DB"})
  ...
  @Test(groups = "Post_TXDO_DB", dependsOnGroups = {"Post_TXDO_Response"})
