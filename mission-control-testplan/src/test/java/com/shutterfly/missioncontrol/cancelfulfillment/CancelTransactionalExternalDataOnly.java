 ...
 *
 */
public class CancelTransactionalExternalDataOnly extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		URL file = Resources.getResource("XMLPayload/CancelFulfillment/CancelTransactionalExternalDataOnly.xml");
