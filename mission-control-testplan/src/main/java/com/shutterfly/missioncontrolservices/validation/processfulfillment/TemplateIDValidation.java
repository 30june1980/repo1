 ...
 *
 */
public class TemplateIDValidation extends ConfigLoader {
	/**
	 * 
	 */
	private String uri = "";
	...
	private String buildPayload() throws IOException {
		...
		return payload = payload.replaceAll("REQUEST_101", record).replaceAll("EOBTemplateC12HD", "");
	...
	private void getResponse() throws IOException {
		...
		response.then().body(
				...
				equalTo(" Template ID is required for each template."));
