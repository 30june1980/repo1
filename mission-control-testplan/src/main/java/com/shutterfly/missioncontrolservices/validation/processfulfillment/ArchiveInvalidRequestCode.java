...
public class ArchiveInvalidRequestCode extends ConfigLoader {
  ...
  String record = Util.getQARandomId();
  ...
  private void validRequestCategories() throws IOException {
    ...
    Response response = given()
        ...
        .body(Util.replaceExactMatch(this.buildPayload(),"TransactionalInlineDataOnly","InvalidRequestCategory")).when().post(this.getProperties());
  ...
  private void nameValuePairMismatch() throws IOException {
    basicConfigNonWeb();
    EncoderConfig encoderconfig = new EncoderConfig();
    String payload = Util.replaceInStringFromTill(this.buildPayload(),"<v7:name>","</v7:name>","");
    Response response = given()
        .config(RestAssured.config()
            .encoderConfig(
                encoderconfig.appendDefaultContentCharsetToContentTypeIfUndefined(false)))
  ...
  private void InvalidRequestDetails() throws IOException {
    ...
    String payload= Util.replaceInStringFromTill(this.buildPayload(),"<sch:archiveTransactionalDetail>","</sch:archiveTransactionalDetail>",toBeReplacedWith);
     Response response = given()
        .config(RestAssured.config()
            .encoderConfig(
                encoderconfig.appendDefaultContentCharsetToContentTypeIfUndefined(false)))
  ...
  private void InvalidRequestDetails_1() throws IOException {
    ...
    String payload= Util.replaceInStringFromTill(this.buildPayloadForArchive(),"<sch:archiveBulkDetail>","</sch:archiveBulkDetail>",toBeReplacedWith);
    Response response = given()
        .config(RestAssured.config()
            .encoderConfig(
                encoderconfig.appendDefaultContentCharsetToContentTypeIfUndefined(false)))
