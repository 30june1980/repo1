package com.shutterfly.missioncontrolservices.validation.processarchive;
...
public class RequestDetailValidation extends ConfigLoader {
  ...
  private String buildPayload() throws IOException {
    ...
    return payload.replaceAll("REQUEST_101", record)
        .replaceAll("BulkDataOnly", "TransactionalExternalDataOnly");
  }
