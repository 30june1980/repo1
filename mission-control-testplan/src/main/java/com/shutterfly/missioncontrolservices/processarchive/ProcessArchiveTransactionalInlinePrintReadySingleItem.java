 ...
 * @author dgupta
 */
public class ProcessArchiveTransactionalInlinePrintReadySingleItem extends ConfigLoader {
  ...
  private String buildPayload() throws IOException {
    URL file = Resources.getResource(
        "XMLPayload/ProcessArchive/ProcessArchiveTransactionalInlinePrintReadySingleItem.xml");
