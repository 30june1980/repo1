 ...
 * @author dgupta
 */
public class StatusAcknowledgementBulkDataOnly_2 extends ConfigLoader {
  ...
  private String buildPayload() throws IOException {
    ...
    record = cwr.getRequestIdByKeys("BDO_SA_2");
  ...
  private void getResponse() throws IOException {
    ...
    EcgFileSafeUtil.updateAndPutFileAtSourceLocation(EcgFileSafeUtil.buildInboundFilePath(payload),
        record, AppConstants.BULK_FILE_INVALID_2, "_StatusAck");
