...
public class AppConstants {
    ...
    public static final String TESTING_SCENARIOS_XL_PATH_PROP = "testingScenariosXlPath";
    ...
    public static final String POST_FOR_ARCHIVE_SUFFIX = "_PostForArchive";
    ...
    public static final String REQUEST_ID_PREFIX = "Automation_";
